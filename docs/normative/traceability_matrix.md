...
| Replay schema stable identity requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-SYS-003** / **HLR-REPLAY-SCHEMA-001** / **LLR-REPLAY-SCHEMA-001** | Status: traced. HLR and LLR are defined for replay schema stable identity ownership. Runtime implementation and verification remain pending. |
...
| Replay input-origin permitted-origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-002** / **LLR-REPLAY-ORIGIN-003** | Status: traced. HLR and LLR are defined for the permitted canonical replay input origins, retained-run origin declaration, and schema permission gate. Implementation and verification remain pending. |
| Retained-run origin content requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-RUN-001** / **LLR-REPLAY-ORIGIN-002** | Status: traced. HLR and LLR are defined for requiring each retained run to declare exactly one canonical replay input origin as retained-run content. Implementation and verification remain pending. |
| Direct saved replay input origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-002** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-005** | Status: traced. HLR and LLR are defined for direct saved replay input as a permitted origin and for excluding invented source identity or source admission information from that origin. Implementation and verification for the general origin model remain pending. |
| Projected admitted source-evidence origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-003** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-004** | Status: traced. HLR and LLR are defined for input projected from admitted source evidence as a permitted origin and for requiring source identity and source admission information when that projected-evidence origin is declared. Implementation and verification remain pending; raw ADC replay projection remains pending at implementation level. |
