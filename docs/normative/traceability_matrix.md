...
| Retained-run format ownership requirements in `docs/normative/HLR_replay.md` | **HLR-REPLAY-SYS-003** | Status: traced. HLR is defined for common retained-run format ownership without owning schema-specific canonical input meaning, execution behavior, trace semantics, or comparison rules. Runtime implementation and verification remain pending. |
| Replay schema stable identity requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-SCHEMA-006** / **LLR-REPLAY-SCHEMA-001** | Status: traced. HLR and LLR are defined for stable replay schema identity used by retained runs, replay execution, traces, comparison, and evaluation. Runtime implementation and verification remain pending. |
| Replay schema permitted input origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-SCHEMA-001** / **LLR-REPLAY-SCHEMA-002** | Status: traced. HLR and LLR are defined for replay schema permitted input origin ownership. Runtime implementation and verification remain pending. |
...
| Replay schema outcome comparison rule requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-SCHEMA-005** / **LLR-REPLAY-SCHEMA-007** | Status: traced. HLR and LLR are defined for replay schema outcome comparison rule ownership. Runtime implementation and verification remain pending. |
| Replay schema execution dependency requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-SCHEMA-007** / **LLR-REPLAY-SCHEMA-008** | Status: traced. HLR and LLR are defined for schema declaration of every execution dependency that may affect state evolution. Runtime implementation and verification remain pending. |
| Replay schema descriptive context boundary requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-SCHEMA-008** / **LLR-REPLAY-SCHEMA-009** / **LLR-REPLAY-SCHEMA-010** | Status: traced. HLR and LLR are defined for separating execution input, execution configuration, schema-defined observable data, and descriptive context. Runtime implementation and verification remain pending. |
| Replay input-origin permitted-origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-001** / **HLR-REPLAY-ORIGIN-005** / **HLR-REPLAY-ORIGIN-006** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-002** / **LLR-REPLAY-ORIGIN-003** / **LLR-REPLAY-ORIGIN-006** | Status: traced. HLR and LLR are defined for stable extensible origin types, retained-run origin declaration, and schema permission gating. Implementation and verification remain pending. |
| Retained-run origin content requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-RUN-001** / **HLR-REPLAY-ORIGIN-006** / **LLR-REPLAY-ORIGIN-002** | Status: traced. HLR and LLR are defined for requiring each retained run to declare exactly one schema-permitted canonical replay input origin as retained-run content. Implementation and verification remain pending. |
| Direct saved replay input origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-002** / **HLR-REPLAY-ORIGIN-005** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-005** | Status: traced. HLR and LLR are defined for direct saved replay input as a current stable origin type and for excluding invented source identity or source admission information from that origin. Implementation and verification for the general origin model remain pending. |
| Projected admitted source-evidence origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-003** / **HLR-REPLAY-ORIGIN-005** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-004** | Status: traced. HLR and LLR are defined for input projected from admitted source evidence as a current stable origin type and for requiring source identity and source admission information when that projected-evidence origin is declared. Implementation and verification remain pending; raw ADC replay projection remains pending at implementation level. |
| Origin-specific admission-boundary requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-004** / **LLR-REPLAY-ORIGIN-004** / **LLR-REPLAY-ORIGIN-005** | Status: traced. HLR and LLR are defined for requiring source admission information only for projected admitted source evidence and for excluding invented source-admission information from direct saved replay input. Implementation and verification remain pending. |
...
| Code Component / Implementation Block | Requirement ID | Traceability Verification |
| :--- | :--- | :--- |
| Retained-run required content requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-RUN-001** / **LLR-REPLAY-RUN-001** / **LLR-REPLAY-RUN-006** | Status: traced. HLR and LLR are defined for the common retained-run content inventory, including schema-declared execution dependencies used by execution. Implementation and verification remain pending. |
