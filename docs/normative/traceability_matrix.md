...
| Replay schema ownership requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-SYS-003** / **HLR-REPLAY-SCHEMA-001** / **HLR-REPLAY-SCHEMA-002** / **HLR-REPLAY-SCHEMA-003** / **HLR-REPLAY-SCHEMA-004** / **HLR-REPLAY-SCHEMA-005** / **LLR-REPLAY-SCHEMA-001** / **LLR-REPLAY-SCHEMA-002** / **LLR-REPLAY-SCHEMA-003** / **LLR-REPLAY-SCHEMA-004** / **LLR-REPLAY-SCHEMA-005** / **LLR-REPLAY-SCHEMA-006** / **LLR-REPLAY-SCHEMA-007** | Status: traced. HLR and LLR are defined for schema ownership of stable identity, permitted input origins, canonical input meaning, state evolution, trace meaning and equality, accepted/rejected/incomplete behavior, and outcome comparison rules. Runtime implementation and verification remain pending. |
