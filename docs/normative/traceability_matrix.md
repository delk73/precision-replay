...
| `execute_replay(...)` in `core/src/replay.rs` | **HLR-REPLAY-EXEC-001** / **HLR-REPLAY-EXEC-002** / **HLR-REPLAY-EXEC-003** / **HLR-REPLAY-EXEC-004** / **HLR-REPLAY-EXEC-005** / **HLR-REPLAY-EXEC-006** / **LLR-REPLAY-EXEC-004** / **LLR-REPLAY-EXEC-005** / **LLR-REPLAY-EXEC-006** | Executes a pure in-memory replay frame slice using the shared fallible `I64F64` add/sub/mul/div paths, rejects invalid frame ordering, result mismatches, and arithmetic traps, and returns a deterministic result. |
