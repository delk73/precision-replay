...
| Retained-run canonicalization-information boundary requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-RUN-001** / **LLR-REPLAY-RUN-001** / **HLR-REPLAY-ORIGIN-006** / **LLR-REPLAY-ORIGIN-002** | Status: traced. HLR and LLR provisionally allow schema-required upstream canonicalization information to be retained without making origin or admission information universal common retained-run content. Its retained-run ownership and identity participation remain unresolved. Implementation and verification remain pending. |
...
| Code Component / Implementation Block | Requirement ID | Traceability Verification |
| :--- | :--- | :--- |
| Retained-run required content requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-RUN-001** / **LLR-REPLAY-RUN-001** / **LLR-REPLAY-RUN-006** | Status: traced. HLR and LLR are defined for the common retained-run content inventory, including schema-declared execution dependencies used by execution and any schema-required upstream canonicalization information retained for that run. Implementation and verification remain pending. |
