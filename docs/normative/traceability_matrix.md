...
| Code Component / Implementation Block | Requirement ID | Traceability Verification |
| :--- | :--- | :--- |
| Pending retained-run execution model | **HLR-REPLAY-EXEC-007** / **HLR-REPLAY-EXEC-008** / **HLR-REPLAY-EXEC-009** / **HLR-REPLAY-EXEC-010** / **HLR-REPLAY-EXEC-011** / **HLR-REPLAY-EXEC-012** / **HLR-REPLAY-EXEC-013** / **HLR-REPLAY-EXEC-014** / **LLR-REPLAY-EXEC-007** / **LLR-REPLAY-EXEC-008** | Status: pending. HLR-defined and LLR-defined retained-run execution model, execution input closure over retained-run-bound dependency values, and undeclared external-state exclusion. Implementation and verification are pending. Existing `execute_replay(...)` satisfies only the initial frame-based math execution HLRs and is not credited with the broader retained-run execution model. |
