...
| Replay input-origin declaration requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-RUN-001** / **HLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-002** / **LLR-REPLAY-ORIGIN-003** | Status: traced. HLR and LLR are defined for declaring one retained-run input origin, limiting origins to direct saved replay input or input projected from admitted source evidence, and requiring schema permission for the declared origin. Runtime implementation and verification remain pending. |
| Direct saved replay input origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-002** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-005** | Status: traced. HLR and LLR are defined for direct saved replay input as a permitted origin and for excluding invented source identity or source admission information from that origin. Runtime implementation and verification for the general origin model remain pending. |
| Projected admitted source-evidence input origin requirements in `docs/normative/HLR_replay.md` and `docs/design/LLR_replay.md` | **HLR-REPLAY-ORIGIN-003** / **HLR-REPLAY-ORIGIN-004** / **LLR-REPLAY-ORIGIN-001** / **LLR-REPLAY-ORIGIN-004** | Status: traced. HLR and LLR are defined for input projected from admitted source evidence as a permitted origin and for requiring source identity and source admission information only when that projected-evidence origin is declared. Runtime implementation and verification remain pending; raw ADC replay projection remains pending. |
