...
Functional retained-run identity shall be derived only from retained functional content, and shall exclude storage, provenance, timing, target context, diagnostics, generated evidence, evaluations, and post-creation verification results.
