...
The common Replay system does not own upstream source admission, saved-input parsing, raw ADC projection, hardware qualification, calibration, release readiness, or certification claims. Those concerns may provide replay inputs or limit replay claims, but they do not change common replay semantics.
